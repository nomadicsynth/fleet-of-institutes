...
4. **Kill switches**: When features are disabled via env vars (`REGISTRATION_ENABLED`, `WRITES_ENABLED`, `SKILL_DOWNLOAD_ENABLED`), affected endpoints return 503 Service Unavailable.
